...
// /particles1/particlesSystemGpu1/easing1
...
//	// INSERT BODY
	...
	// /particles1/particlesSystemGpu1/easing1
	vec3 v_POLY_easing1_out = vec3(exponentialInOut(v_POLY_acceleration1_velocity.x), exponentialInOut(v_POLY_acceleration1_velocity.y), exponentialInOut(v_POLY_acceleration1_velocity.z));
	
	// /particles1/particlesSystemGpu1/velocity_output
	gl_FragColor.xyz = v_POLY_easing1_out;
